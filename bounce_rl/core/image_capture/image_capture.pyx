...
cdef class ImageCapture:
    ...
    def __cinit__(self, x, y, width, height, window):
        self._image_capture = image_capture.SetupImageCapture(x, y, width, height, window)
        self._width = width
        self._height = height
    ...
    def get_image(self):
        ...
        shape[1] = self._width
        shape[2] = 4
        cdef char* image_data = image_capture.CaptureImage(self._image_capture)
